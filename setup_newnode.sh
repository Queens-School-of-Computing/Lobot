...
# add lab tag
kubectl label nodes NODENAMEHERE lab=caslab 
...
kubectl label nodes NODENAMEHERE hardware-type=NVIDIAGPU

kubectl label nodes NODENAMEHERE nvidia.com/brand=NVIDIA-A40 
